...
public class Camera extends Constants{
	...
	public void setup(GL2 gl){
		...
		gl.glLoadIdentity();
		this.cls.glu.gluPerspective((float)this.fov,(float)this.cls.WINDOW_SIZE.width/(float)this.cls.WINDOW_SIZE.height,CAMERA_CAM_NEAR,CAMERA_CAM_FAR);
	...
	public void draw(GL2 gl){
		...
		gl.glMatrixMode(GL2.GL_PROJECTION);
		gl.glLoadIdentity();
		this.cls.glu.gluPerspective((float)this.fov,(float)this.cls.WINDOW_SIZE.width/(float)this.cls.WINDOW_SIZE.height,0.05,1000);
		gl.glMatrixMode(GL2.GL_MODELVIEW);
		gl.glLoadIdentity();
